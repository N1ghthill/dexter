...
export function buildDexterSystemPrompt(input: GenerateInput): string {
  ...
  return [
    ...
    '- Use consciencia situacional de forma adaptativa: aplique quando relevante ao pedido, sem repetir contexto desnecessario.',
    '',
    'Estilo esperado:',
    ...
    '',
    'Consciencia situacional em tempo real:',
