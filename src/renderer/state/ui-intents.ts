...
export type LegacyUiCommand =
  ...
  | 'uninstall-package-mode-change'
  | 'uninstall-remove-user-data-change'
  | 'uninstall-remove-runtime-system-change'
  | 'uninstall-remove-runtime-user-data-change'
  | 'uninstall-token-input'
  | 'uninstall-run'
  | 'history-prev'
  | 'history-next'
